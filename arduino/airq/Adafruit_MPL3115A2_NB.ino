/*!
 *  @file Adafruit_MPL3115A2_NB.cpp
 *
...
*/
Adafruit_MPL3115A2_NB::Adafruit_MPL3115A2_NB() {}
 ...
 */
boolean Adafruit_MPL3115A2_NB::begin(TwoWire *twoWire) {
  if (i2c_dev)
    delete i2c_dev;
 ...
 */
float Adafruit_MPL3115A2_NB::getPressure() {
 ...
 */
uint8_t Adafruit_MPL3115A2_NB::getPressureNonBlocking(float &pressure) {
  uint32_t pval;
 ...
 */
float Adafruit_MPL3115A2_NB::getAltitude() {
  // wait for one-shot to clear before proceeding
  while (read8(MPL3115A2_CTRL_REG1) & MPL3115A2_CTRL_REG1_OST)
    delay(10);
 ...
 */
void Adafruit_MPL3115A2_NB::setSeaPressure(float SLP) {
 ...
 */
float Adafruit_MPL3115A2_NB::getTemperature() {
  // wait for one-shot to clear before proceeding
  while (read8(MPL3115A2_CTRL_REG1) & MPL3115A2_CTRL_REG1_OST)
    delay(10);
 ...
 */
uint8_t Adafruit_MPL3115A2_NB::read8(uint8_t a) {
  uint8_t buffer[1] = {a};
 ...
 *          the byte to write
 */
void Adafruit_MPL3115A2_NB::write8(uint8_t a, uint8_t d) {
